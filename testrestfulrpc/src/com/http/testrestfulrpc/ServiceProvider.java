...
/*
 * 请求地址
 * http://localhost:8080/testrestfulrpc/provider/sayhelloservice/2013-11-12-11-
 * 12-23.json
 */
@Controller
public class ServiceProvider {
	...
	public JsonResult provide(HttpServletRequest request, HttpServletResponse response,
			@PathVariable("servicename") String servicename, @PathVariable("timestamp") Date timestamp) {
